  ...
  products.map((value, index) => {
    data += /*html*/ `
      <div class="col-lg-3 col-md-4 col-6">
        <a href="../product/product.html" onclick="renderProductsItem(${index})">
          <div class="item-box">
...
//     image: [
//       "https://shopdunk.com/images/thumbs/0022263_iphone-15-pro-128gb_240.png",
//       "https://shopdunk.com/images/thumbs/0019560_titan-xanh_550.jpeg",
//       "https://shopdunk.com/images/thumbs/0019562_titan-xanh_550.jpeg",
//     ],
//     price: "27,490,000",
//   },
//   {
...
//     image: [
//       "https://shopdunk.com/images/thumbs/0020318_iphone-15-plus-256gb_240.webp",
//       "https://shopdunk.com/images/thumbs/0020007_iphone-15-plus-256gb_550.jpeg",
//       "https://shopdunk.com/images/thumbs/0020006_iphone-15-plus-256gb_550.jpeg",
//     ],
//     price: "28,490,000",
//   },
//   {
...
//     name: "iPhone 15 128 GB",
//     image: [
//       "https://shopdunk.com/images/thumbs/0022255_iphone-15-128gb_240.png",
//       "https://shopdunk.com/images/thumbs/0019799_black_550.jpeg",
//       "https://shopdunk.com/images/thumbs/0019800_black_550.jpeg",
//     ],
//     price: "21,790,000",
//   },
//   {
...
//     image: [
//       "https://shopdunk.com/images/thumbs/0022266_iphone-15-pro-max-256gb_240.png",
//       "https://shopdunk.com/images/thumbs/0020080_iphone-15-pro-max-128gb_550.jpeg",
...
//     let object = JSON.stringify(products[i]);
//     str += /*html*/ `
//       <div class="col-lg-3 col-md-4 col-6">
//         <a href="#" onclick=\'renderProductsItem(\`${object}\`)\'>
//           <div class="item-box">
//             <div class="product-item">
//               <div class="product-tag"></div>
//               <div class="product-picture">
...
//                 </h3>
//                 <div class="add-infor">
//                   <span class="price actual-price">${products[i].price}</span>
//                 </div>
//               </div>
//             </div>
//           </div>
...
// function renderProductsItem(objectSP) {
//   console.log(objectSP);
//   window.localStorage.setItem("sanpham", objectSP);
//   location.href = "../product/product.html";
// }
// function showDetail() {
//   let objectSP = JSON.parse(localStorage.getItem("sanpham"));
//   document.querySelector(".main-img").src = `${objectSP.image[0]}`;
//   let strImg = "";
//   for (let i = 0; i < objectSP.image.length; i++) {
//     strImg += `
//               <img
//                 src="${objectSP.image[i]}"
//                 alt=""
//               />`;
//   }
//   document.querySelector(".item").innerHTML = strImg;
//   document.querySelector(".ten-sp").innerHTML = `${objectSP.name}`;
//   document.querySelector(".gia-sp").innerHTML = `${objectSP.price}`;
// }
